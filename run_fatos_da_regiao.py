...
Fontes: Tribuna do Paraná, Bem Paraná, Banda B, Gazeta do Povo, O Maringá, Folha de Londrina, Diário de Foz e Rede Sul de Notícias.
...
def run_pipeline(
    ...
    with Progress(
        ...
        # 1. Coleta
        task1 = progress.add_task("Coletando notícias dos portais de Curitiba, RMC e interior do Paraná...", total=None)
    ...
    if "all" in formats or "html" in formats:
        html_file = save_html_report(
            ...
            footer_text="Gerado via Tribuna PR, Bem Paraná, Banda B, Gazeta do Povo, O Maringá, Folha de Londrina, Diário de Foz, RSN & Google Gemini • Fatos da Região"
        )
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="IDs de feeds regionais específicos separados por vírgula (ex: tribunapr_direct,omaringa_direct,folhadelondrina_direct,diariodefoz_direct,redesulnoticias_direct)"
    )
    parser.add_argument(
        "--output",
